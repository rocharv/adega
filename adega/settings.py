...
SECRET_KEY = 'django-insecure-$sg77xv1-n=xy3kis9zoay$11@q%1a=5u5)fwd01il(6g4ie=o'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.locale.LocaleMiddleware', # let browser decide lang
...
DATABASES = {
    'default': {
        ...
        'USER': 'adega_user',
        'PASSWORD': 'adega_pw',
        'HOST': 'localhost', # change it after app goes to production
        'PORT': '5432',
    }
}
